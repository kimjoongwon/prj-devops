...
# - Keys: OBJECT_STORAGE_ACCESS_KEY,OBJECT_STORAGE_SECRET_KEY,OBJECT_STORAGE_REGION,OBJECT_STORAGE_BUCKET,OBJECT_STORAGE_ENDPOINT,OBJECT_STORAGE_API_TOKEN
...
INFRA_KEYS="${INFRA_KEYS:-OBJECT_STORAGE_ACCESS_KEY,OBJECT_STORAGE_SECRET_KEY,OBJECT_STORAGE_REGION,OBJECT_STORAGE_BUCKET,OBJECT_STORAGE_ENDPOINT,OBJECT_STORAGE_API_TOKEN}"
