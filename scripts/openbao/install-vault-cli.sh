...
echo ""
echo "   영구 설정 (bash):"
echo "   echo 'export VAULT_ADDR=https://openbao.onjitda.com' >> ~/.bashrc"
echo "   source ~/.bashrc"
echo ""
echo "   영구 설정 (zsh):"
echo "   echo 'export VAULT_ADDR=https://openbao.onjitda.com' >> ~/.zshrc"
echo "   source ~/.zshrc"
echo ""
echo "3. 연결 테스트:"
echo "   vault status"
...
echo ""
echo "5. 시크릿 읽기:"
echo "   vault kv get secret/core-api/staging"
echo ""
