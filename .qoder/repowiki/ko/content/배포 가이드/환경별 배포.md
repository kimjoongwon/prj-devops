...
**스크립트 소스**
- [plate-api/values-stg.yaml](file://helm/applications/plate-server/values-stg.yaml#L7-L10)
- [plate-api/values-prod.yaml](file://helm/applications/plate-server/values-prod.yaml#L7-L10)
...
**스크립트 소스**
- [plate-api/values-stg.yaml](file://helm/applications/plate-server/values-stg.yaml#L21-L27)
- [plate-api/values-prod.yaml](file://helm/applications/plate-server/values-prod.yaml#L22-L28)
