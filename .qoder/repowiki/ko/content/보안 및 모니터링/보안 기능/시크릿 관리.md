...
**다이어그램 소스**
- [plate-api/values.yaml](file://helm/applications/plate-api/values.yaml#L32-L85)
- [plate-api/templates/deployment.yaml](file://helm/applications/plate-api/templates/deployment.yaml#L33-L41)
