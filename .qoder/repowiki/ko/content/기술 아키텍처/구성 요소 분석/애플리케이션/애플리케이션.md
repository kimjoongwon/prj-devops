...
**Section sources**
- [plate-api/Chart.yaml](file://helm/applications/plate-server/Chart.yaml#L1-L16)
- [plate-api/values.yaml](file://helm/applications/plate-server/values.yaml#L1-L85)
- [plate-api/values-stg.yaml](file://helm/applications/plate-server/values-stg.yaml#L1-L19)
- [plate-api/values-prod.yaml](file://helm/applications/plate-server/values-prod.yaml#L1-L22)
...
- [plate-api/values.yaml](file://helm/applications/plate-server/values.yaml#L31-L85)
...
**Section sources**
- [plate-api/values.yaml](file://helm/applications/plate-server/values.yaml#L14-L20)
